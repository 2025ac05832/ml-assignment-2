...
def main() -> None:
    ...
    parser.add_argument("--csv", default=datasets.DEFAULT_CSV)
    parser.add_argument("--target", default=datasets.DEFAULT_TARGET)
    ...
    # ---------------- load ----------------
    try:
        ds = datasets.load(args.csv, args.target, args.drop)
